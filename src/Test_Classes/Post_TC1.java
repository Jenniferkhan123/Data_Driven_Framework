...
import Request_Repository.Post_Req_Respository;
...
public class Post_TC1 {
	public static void execute() throws IOException {
		...
		for (int i =0 ; i <5 ; i++) {
			int statusCode = API_Methods.ResponseStatusCode(Post_Req_Respository.baseURI(), Post_Req_Respository.Post_Resource(), Post_Req_Respository.Post_TC1());
		   	
		    if(statusCode==201)
		    {
		        System.out.println(statusCode);
		        
			    String ResponseBody = API_Methods.ResponseBody(Post_Req_Respository.baseURI(), Post_Req_Respository.Post_Resource(), Post_Req_Respository.Post_TC1());
				//System.out.println( ResponseBody);
				
				String RequestBody = Post_Req_Respository.Post_TC1();
